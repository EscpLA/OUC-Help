      ...
      <slot>
		...
		'uni-date-x--border': border}">
          ...
          <view v-else class="uni-date-x uni-date-range">
            ...
            <input class="uni-date__x-input t-c" type="text" v-model="range.endDate" :placeholder="endPlaceholderText"
              :disabled="true" />
          </view>
    ...
    <view v-if="!isPhone" ref="datePicker" v-show="popup" class="uni-date-picker__container">
      <view v-if="!isRange" class="uni-date-single--x" :style="popover">
        ...
        <view v-if="hasTime" class="uni-date-changed popup-x-header">
          ...
          <time-picker type="time" v-model="time" :border="false" :disabled="!tempSingleDate" :start="reactStartTime"
        ...
        <calendar ref="pcSingle" :showMonth="false" :start-date="caleRange.startDate" :end-date="caleRange.endDate"
          :date="defSingleDate" @change="singleChange" style="padding: 0 8px;" />
